...
class RecordFilter(django_filters.FilterSet):
	...
	workTitle  = CharFilter(label='Work Title',field_name='workTitle', lookup_expr='icontains',widget=forms.TextInput(attrs={'class': 'form-group'}))
	...
	class Meta:
		model = Record
		fields = ['authorEnglish2','authorKorean','workTitle', 'translator', 'start_date', 'end_date', 'year', 'sourceTitle', 'genre']
